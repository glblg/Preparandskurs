function moriskan() {
    ...
    if (vip && age >= 18) {
        //Är du både of age och en vip så har du tur
...
/*  if (vip) resultat.innerHTML = 'welcome..... :) ';
    else if (age >= 18) resultat.innerHTML = 'access granted ';
    else resultat.innerHTML = 'access denied '; */
}
